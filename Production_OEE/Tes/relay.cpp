...
void loop() {
  ...
  // Map nilai potensiometer ke interval relay
  relayInterval = map(potentiometerValue, 0, 4095, 100, 1000);

  // Mengirimkan nilai potensiometer melalui SoftwareSerial
  mySerialLora.println(potentiometerValue);
  ...
  // Penundaan waktu agar ritme pengiriman data dapat dikontrol
  delay(20);
}
