...
void setup() {
  ...
  pinMode(buttonPinA4, INPUT); // New button pin setup
...
void loop() {
  ...
  checkButton(buttonPinA4, lastButtonStateA4, buttonStateA4, lastDebounceTimeA4, dataOnA4, dataOffA4); // New check for buttonPinA4
  delay(100);
}